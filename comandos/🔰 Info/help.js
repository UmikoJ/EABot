        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.EmbedBuilder()
                    ...
                    .setFooter({ text: `© desarrollado por Samm#3479 | 2022`, iconURL: `https://cdn.discordapp.com/avatars/1027942233225314375/9d3b79f95cb4d893b142d24e213c72d3.webp?size=240` })
            ...
            .setColor(client.color)
            .setDescription(`Bot Multifuncional en desarrollo por \`Samm#3479\``)
            ...
            .addFields([{name: `📈 **__ESTADÍSTICAS__**`, value: `⚙ **${client.commands.size} Comandos**\n📁 en **${client.guilds.cache.size} Servidores**\n📶 **\`${client.ws.ping}ms\` Ping**\n👤 desarrollado por **[Samm#3479](https://discord.gg/34WEWPaW9X)**`}], )
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© desarrollado por Samm#3479 | 2022`, iconURL: `https://cdn.discordapp.com/avatars/1027942233225314375/9d3b79f95cb4d893b142d24e213c72d3.webp?size=240` })
